...
class TestSendLog:
    ...
    def test_has_been_sent_true(self):
        ...
        append_send_record(self.log_path, record)
        assert has_been_sent(self.log_path, "의약품", "2026-08") is True

    def test_has_been_sent_false(self):
        init_log_file(self.log_path)
        assert has_been_sent(self.log_path, "의약품", "2026-08") is False
    ...
    def test_different_category_independent(self):
        ...
        append_send_record(self.log_path, record)
        assert has_been_sent(self.log_path, "의료기기", "2026-08") is False
